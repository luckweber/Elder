...
void UElderDamageGameplayAbility::CauseDamage(AActor* TargetActor)
{
...
FDamageEffectParams UElderDamageGameplayAbility::MakeDamageEffectParamsFromClassDefaults(AActor* TargetActor,
...
float UElderDamageGameplayAbility::GetDamageAtLevel() const
{
	return Damage.GetValueAtLevel(GetAbilityLevel());
}

FTaggedMontage UElderDamageGameplayAbility::GetRandomTaggedMontageFromArray(
